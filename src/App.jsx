    ...
    <Navbar />
     <div className="container mx-auto my-5 p-5 rounded-l bg-violet-300 min-h-[80vh]">
      <div className="addtodo my-5">
        ...
        <button onClick={handleAdd} className='font-bold bg-violet-600 hover:bg-violet-900 p-2 py-0.5 text-white rounded-lg mx-4 '>Add to do</button>
      </div>
        ...
        <div className="todos">
          ...
          return <div key={item.id} className="todo flex w-1/3 justify-between my-3">
            ...
            <div className="buttons">
              <button onClick={handleEdit} className='font-bold bg-violet-600 hover:bg-violet-900 p-2 py-0.5 text-white rounded-lg mx-2 '>Edit</button>
